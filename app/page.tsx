  ...
  return (
    <>
      <style jsx global>{`
        ...
        .glow-effect {
          box-shadow: 0 0 60px rgba(83, 224, 255, 0.15);
        }
        
        .glow-acid {
          box-shadow: 0 0 60px rgba(213, 255, 95, 0.2);
        }
        
        .ambient-light {
          background: radial-gradient(ellipse at top, rgba(83, 224, 255, 0.08) 0%, transparent 50%),
                      radial-gradient(ellipse at bottom right, rgba(213, 255, 95, 0.05) 0%, transparent 50%);
        }
        ...
        .text-gradient {
          background: linear-gradient(135deg, #53e0ff 0%, #a78bfa 50%, #d5ff5f 100%);
        ...
        .border-gradient {
          position: relative;
          background: linear-gradient(135deg, rgba(83, 224, 255, 0.3), rgba(167, 139, 250, 0.3), rgba(213, 255, 95, 0.3));
          padding: 1px;
      ...
      <main className="min-h-screen bg-black text-[#f5f1e8] ambient-light">
        {/* Navigation */}
        <nav className="fixed left-4 right-4 top-5 z-50 mx-auto flex max-w-5xl items-center justify-between glass-strong px-4 py-3 shadow-2xl shadow-black/30 md:px-5">
          <a href="#home" className="font-display text-lg text-gradient">
            AMAN.
          </a>
          ...
          <div className="hidden items-center gap-6 text-xs uppercase text-[#f5f1e8]/60 md:flex">
            {["Work", "About", "Contact"].map((item) => (
              <a
                ...
                className="transition hover:text-[#f5f1e8] hover:text-gradient"
              >
                {item}
              </a>
            ))}
          ...
          <a
            ...
            className="grid h-9 w-9 place-items-center border border-white/10 transition hover:border-[#d5ff5f] hover:text-[#d5ff5f] hover:glow-acid"
          >
        ...
        <section id="home" className="relative min-h-screen flex items-center justify-center px-5 pt-20">
          <div className="relative z-10 mx-auto max-w-7xl text-center">
            <div className="mb-8 flex flex-wrap items-center justify-center gap-3 text-xs uppercase text-[#f5f1e8]/60">
              <span className="glass-soft px-3 py-2 border border-white/10">
                Software engineer
              </span>
              <span className="glass-soft px-3 py-2 border border-white/10">
                AI builder
            ...
            <h1 className="max-w-6xl mx-auto font-display text-[clamp(3rem,10vw,8rem)] font-medium leading-[0.9] tracking-normal text-gradient gradient-animate">
          ...
          <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-[#53e0ff]/10 rounded-full blur-3xl float-animation" />
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#a78bfa]/10 rounded-full blur-3xl float-animation" style={{ animationDelay: "2s" }} />
        </section>

        {/* Bento Grid Section */}
        <section id="work" className="relative px-5 py-24 md:px-10 md:py-36">
          <div className="mx-auto max-w-7xl">
            <div className="mb-12 inline-flex items-center gap-3 glass-soft px-3 py-2 text-xs uppercase text-[#f5f1e8]/45 border border-white/10">
            ...
            <h2 className="mb-16 font-display text-[clamp(2.5rem,6vw,5rem)] leading-[0.92] text-gradient">
            ...
            <div className="grid gap-4 md:grid-cols-2 md:grid-rows-2">
              ...
              <div className="group relative overflow-hidden glass-soft p-6 md:p-8 transition-all duration-500 hover:scale-[1.02] hover:glow-effect md:row-span-2 border border-[#53e0ff]/30">
                {/* Icon */}
                <div className="mb-6 flex h-14 w-14 items-center justify-center border border-[#53e0ff]/30 text-[#53e0ff] transition group-hover:scale-110 group-hover:glow-effect">
                ...
                <h3 className="font-display text-2xl md:text-3xl mb-4 text-[#53e0ff]">
                  Orthosyn Medikal
                </h3>
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                  <div className="glass-soft p-3 border border-white/5">
                    <div className="font-display text-xl md:text-2xl text-[#53e0ff]">12+</div>
                    <div className="mt-1 text-xs uppercase text-[#f5f1e8]/40">
                      Markets
                    </div>
                  </div>
                  <div className="glass-soft p-3 border border-white/5">
                    <div className="font-display text-xl md:text-2xl text-[#53e0ff]">Global</div>
                    <div className="mt-1 text-xs uppercase text-[#f5f1e8]/40">
                      Supply Chains
                    </div>
                  </div>
                  <div className="glass-soft p-3 border border-white/5">
                    <div className="font-display text-xl md:text-2xl text-[#53e0ff]">High</div>
                    <div className="mt-1 text-xs uppercase text-[#f5f1e8]/40">
                      B2B Volume
                    </div>
                  </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {["International Trade", "Medical Supply", "Logistics Architecture", "Commercial Coordination"].map((feature) => (
                    <span
                      key={feature}
                      className="glass-soft border border-white/10 px-3 py-1.5 text-xs uppercase text-[#f5f1e8]/50"
                    >
                      {feature}
                    </span>
                  ))}
              ...
              <div className="group relative overflow-hidden glass-soft p-6 md:p-8 transition-all duration-500 hover:scale-[1.02] hover:glow-effect border border-[#ff6b57]/30">
                {/* Icon */}
                ...
                <h3 className="font-display text-2xl md:text-3xl mb-4 text-[#ff6b57]">
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                  <div className="glass-soft p-3 border border-white/5">
                    <div className="font-display text-xl md:text-2xl text-[#ff6b57]">50+</div>
                    <div className="mt-1 text-xs uppercase text-[#f5f1e8]/40">
                      Reports
                    </div>
                  </div>
                  <div className="glass-soft p-3 border border-white/5">
                    <div className="font-display text-xl md:text-2xl text-[#ff6b57]">15+</div>
                    <div className="mt-1 text-xs uppercase text-[#f5f1e8]/40">
                      Markets
                    </div>
                  </div>
                  <div className="glass-soft p-3 border border-white/5">
                    <div className="font-display text-xl md:text-2xl text-[#ff6b57]">10K+</div>
                    <div className="mt-1 text-xs uppercase text-[#f5f1e8]/40">
                      Data Points
                    </div>
                  </div>
              ...
              <div className="group relative overflow-hidden glass-soft p-6 md:p-8 transition-all duration-500 hover:scale-[1.02] hover:glow-effect border border-[#a78bfa]/30">
                {/* Icon */}
                ...
                <h3 className="font-display text-2xl md:text-3xl mb-4 text-[#a78bfa]">
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                  <div className="glass-soft p-3 border border-white/5">
                    <div className="font-display text-xl md:text-2xl text-[#a78bfa]">Full Stack</div>
                    <div className="mt-1 text-xs uppercase text-[#f5f1e8]/40">
                      Architecture
                    </div>
                  </div>
                  <div className="glass-soft p-3 border border-white/5">
                    <div className="font-display text-xl md:text-2xl text-[#a78bfa]">Urban</div>
                    <div className="mt-1 text-xs uppercase text-[#f5f1e8]/40">
                      Model
                    </div>
                  </div>
                  <div className="glass-soft p-3 border border-white/5">
                    <div className="font-display text-xl md:text-2xl text-[#a78bfa]">Scalable</div>
                    <div className="mt-1 text-xs uppercase text-[#f5f1e8]/40">
                      Scale
                    </div>
                  </div>
              ...
              <Link
                ...
                className="group relative overflow-hidden glass-soft p-6 md:p-8 transition-all duration-500 hover:scale-[1.02] hover:glow-acid flex flex-col justify-center items-center text-center border border-[#d5ff5f]/30"
              >
                {/* Pulsing glow effect */}
                <div className="absolute inset-0 bg-[#d5ff5f]/5 pulse-glow" />
                
                <div className="relative z-10 flex h-16 w-16 items-center justify-center border border-[#d5ff5f]/50 text-[#d5ff5f] mb-4 transition group-hover:scale-110 group-hover:glow-acid">
            ...
            <div className="grid gap-4 md:grid-cols-4">
              {[
                ...
                <article
                  ...
                  className="group min-h-72 glass-soft p-6 transition-all duration-500 hover:border-[#d5ff5f]/60 hover:bg-white/[0.05] hover:-translate-y-2 border border-white/10"
                >
                  <div className="mb-16 flex h-11 w-11 items-center justify-center border border-white/10 text-[#d5ff5f] transition group-hover:scale-110 group-hover:glow-acid">
                    {experience.icon}
                  </div>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-5">
              {["React", "Next.js", "TypeScript", "AI Agents", "Python", "Trade Analytics", "Supply Chains", "UX Systems", "Startups"].map((skill) => (
                <div
                  key={skill}
                  className="flex aspect-square items-end glass-soft p-4 font-display text-xl transition-all duration-500 hover:border-[#53e0ff]/70 hover:text-[#53e0ff] hover:-translate-y-1 border border-white/10"
                >
                  {skill}
                </div>
              ))}
        ...
        <section id="contact" className="px-5 py-24 md:px-10 md:py-36">
          <div className="mx-auto max-w-7xl border-t border-white/10 pt-16">
            ...
            <h2 className="max-w-5xl font-display text-[clamp(3rem,8vw,7rem)] leading-[0.86] text-gradient">
            ...
            <div className="mt-12 flex flex-wrap gap-4">
              <a
                href="mailto:hello@amankhannpl.com"
                className="inline-flex items-center gap-3 border border-[#d5ff5f]/50 px-5 py-4 text-[#d5ff5f] transition hover:bg-[#d5ff5f] hover:text-black hover:glow-acid glass-soft"
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
                  <polyline points="22,6 12,13 2,6"/>
              ...
              <a
                ...
                className="grid h-14 w-14 place-items-center border border-white/10 transition hover:border-[#f5f1e8] hover:glow-effect glass-soft"
                aria-label="GitHub"
              >
